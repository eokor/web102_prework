...
numGamesCard.innerHTML = `${totalGames.toLocaleString()}`;
...
let unfundedStr = totalGames > 0
    ? `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} ${totalGames > 1 ? "games" : "game"}. Currently, ${numUnfundedGames} ${numUnfundedGames > 1 ? "games remain unfunded. We need you help to fund these amazing games!" : "game remains unfunded. We need you help to fund this amazing game!"}`
    : "All our games have been funded! Thank you for your support!";
